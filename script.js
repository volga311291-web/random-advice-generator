...
const adviceList = [
    ...
    "🚶‍♀️ После еды постойте или пройдитесь 5 минут — полезно для пищеварения",
    "🧾 Раз в месяц проверяйте подписки — отключайте ненужные"
    "🔇 Отключайте уведомления в приложениях, кроме самого важного",
    "🧥 Проверяйте прогноз погоды вечером — утром будет меньше суеты",
    "🧠 Каждый день узнавайте одно новое слово",
    "🦷 Чистите зубы 2 минуты, не спеша",
    "🍽️ Ешьте без телефона — так быстрее наступает насыщение",
    "📸 Фотографируйте хорошие моменты — пересматривайте в плохие дни",
    "🕰️ Вставайте на 15 минут раньше — утро перестанет быть спешкой",
    "📦 Раз в месяц выбрасывайте одну ненужную вещь",
    "🚪 Выходите на улицу в первую минуту, когда заметили, что заскучали",
    "🧦 Меняйте носки каждый день — это гигиена и комфорт",
    "🚰 Держите стакан воды на рабочем столе — так вы будете пить чаще",
    "🧴 Наносите солнцезащитный крем даже в пасмурную погоду",
